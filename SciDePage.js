...
import mathsci from '../img/mathsci.jpg'
...
class SciDePage extends Component { 
    constructor(props){
        super(props)
        this.state= {
            show1 : null ,
            ...
            show5 : null ,
            show6 : null ,
            sciCSview : localStorage.getItem("comscicount") ,
            sciMTHview : localStorage.getItem("mathcount") ,
            sciPYview : localStorage.getItem("physcicount")
        }
    ...
    render() {
        return (
            ...
            <div>
                    ...
                    <div className="container">
                        <div className="header-container d-flex align-items-center">
                            <div className="logo mr-auto">
                                <h1 className="text-light"><a href="#header"><span>Factory of Science </span></a></h1>
                ...
                <section id="sci" className="sci">
                    <div className="container">
                        <div className="text-center" data-aos="zoom-in">
                            <h3 className="mt-5">Factory of Science</h3>
                            ...
                            <div className="col-lg-8" data-aos="fade-up" data-aos-delay={100}>
                                <div className="owl-carousel testimonials-carousel">
                                    ...
                                    <div className="testimonial-item">
                                        ...
                                        <img src={comsci} className="sci-factor container mt-2" alt />
                                        <p className="mt-3">
                                    ...
                                    <div className="testimonial-item">
                                        ...
                                        <img src={mathsci} className="sci-factor container mt-2" alt />
                                        <p className="mt-3">
                                            <i className="bx bxs-quote-alt-left quote-icon-left " />
                                         Proin iaculis purus consequat sem cure digni ssim donec porttitora entum suscipit rhoncus. Accusantium quam, ultricies eget id, aliquam eget nibh et. Maecen aliquam, risus at semper.
                                         <i className="bx bxs-quote-alt-right quote-icon-right" />
                                    ...
                                    <div className="testimonial-item">
                                        ...
                                        <img src={physicsci} className="sci-factor container mt-2" alt />
                                        <p className="mt-3">
                                            <i className="bx bxs-quote-alt-left quote-icon-left " />
                                         Proin iaculis purus consequat sem cure digni ssim donec porttitora entum suscipit rhoncus. Accusantium quam, ultricies eget id, aliquam eget nibh et. Maecen aliquam, risus at semper.
                                         <i className="bx bxs-quote-alt-right quote-icon-right" />
