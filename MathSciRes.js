...
class MathSciRes extends Component {
    ...
    componentDidMount() {
        const stringCount = localStorage.getItem("mathcount" );
        const mathcount  = parseInt(stringCount, 10);
  
        if (!isNaN(mathcount) ) {
          this.setState(() => ({ mathcount }));
        }
      }
    
      componentDidUpdate(prevProps, prevState) {
        if (prevState.mathcount !== this.state.mathcount) {
          localStorage.setItem("mathcount", this.state.mathcount);
        }
        ...
        if (prevState.userpoint !== this.state.userpoint){
            ...
            this.setState({
                series: [
                    {
                        name: "Highest Point",
                        data: [16819,	16331,	17027,	14796,	15607,	16365,	15607]
                    },
                    {
                        name: "Lowest Point ",
                        data: [13742,	13839,	13302,	9071,	11716,	11399,	11716]
                    },
                    {
                        name: "My Point",
    ...
    handleAddOne() {
        this.setState(prevState => {
          return {
            mathcount: prevState.mathcount +1
          };
        }
        );
      }
    render() {
        return (<React.Fragment>
            ...
            <header id="header" className="fixed-top d-flex align-items-center">
                    <div className="container">
                        <div className="header-container d-flex align-items-center">
                            <div className="logo mr-auto">
                                <h1 className="text-light"><a href="#header"><span>Mathematics Science</span></a></h1>
                ...
                <section id="sci" className="sci-mth">
                    <div className="container">
                        <div className="text-center" data-aos="zoom-in">
                            <h3 className="mt-5">Department of Mathematics Science</h3>
                    ...
                    <div className="testimonials section-bg ">
                        ...
                        <div className="testimonial-item1 container mt-5">
                                ...
                                <br />
                                <br />
                            <h3 >สาขาคณิตศาสตร์ </h3>
                            <h4>Department of Mathematics Science</h4>
                            <h4>จำนวนผู้เข้าชม : {this.state.mathcount}</h4>
