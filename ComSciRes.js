...
import comsci from '../img/comsci.jpg';
import ApexChart from './ApexChart';
import './SciDec.css';


class ComSciRes extends Component {
    ...
    constructor(props) {
        ...
        this.handleAddOneComSci = this.handleAddOneComSci.bind(this);
    ...
    updateChart(e) {
        ...
        this.setState({
            series: [
                ...
                {
                    name: "My Point",
                    data: [(userpoint), (userpoint), (userpoint), (userpoint), (userpoint), (userpoint), (userpoint)]
                }
            ],
        }) 
    }
    ...
    componentDidMount() {
        const stringCount = localStorage.getItem("comscicount" );
        const comscicount  = parseInt(stringCount, 10);
  
        if (!isNaN(comscicount) ) {
          this.setState(() => ({ comscicount }));
        }
      }
    
      componentDidUpdate(prevProps, prevState) {
        if (prevState.comscicount !== this.state.comscicount) {
          localStorage.setItem("comscicount", this.state.comscicount);
        }
    ...
    handleAddOneComSci() {
        this.setState(prevState => {
          return {
            comscicount: prevState.comscicount +1
          };
        }
        );
      }
    ...
    render() {
        return (<React.Fragment>
            ...
            <header id="header" className="fixed-top d-flex align-items-center">
                    <div className="container">
                        <div className="header-container d-flex align-items-center">
                            <div className="logo mr-auto">
                                <h1 className="text-light"><a href="#header"><span>Computer Science </span></a></h1>
                ...
                <section id="sci" className="sci-cs">
                    <div className="container">
                        <div className="text-center" data-aos="zoom-in">
                            <h3 className="mt-5">Department of ComputerScience</h3>
                    ...
                    <div className="testimonials section-bg ">
                        ...
                        <div className="testimonial-item1 container mt-5">
                                ...
                                <br />
                                <br />
                            <h3 >สาขาวิทยาการคอมพิวเตอร์ </h3>
                            <h4>Department of Computer Science</h4>
                            <h4>จำนวนผู้เข้าชม : {this.state.comscicount}</h4>
