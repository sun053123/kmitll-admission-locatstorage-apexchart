...
class ChemEnRes extends Component {
    ...
    componentDidMount() {
        const stringCount = localStorage.getItem("chemencount" );
        const chemencount  = parseInt(stringCount, 10);
  
        if (!isNaN(chemencount) ) {
          this.setState(() => ({ chemencount }));
        }
      }
    
      componentDidUpdate(prevProps, prevState) {
        if (prevState.chemencount !== this.state.chemencount) {
          localStorage.setItem("chemencount", this.state.chemencount);
        }
        ...
        if (prevState.userpoint !== this.state.userpoint){
            ...
            this.setState({
                series: [
                    {
                        name: "Highest Point",
                        data: [21704,	20873,	21530,	19583,	20598,	20043,	20384]
                    },
                    {
                        name: "Lowest Point ",
                        data: [18905,	18002,	20510,	18632	,17923,	19536	,19627]
                    },
                    {
                        name: "My Point",
    ...
    handleAddOne() {
        this.setState(prevState => {
          return {
            chemencount: prevState.chemencount +1
          };
        }
        );
      }
    render() {
        return (<React.Fragment>
            ...
            <header id="header" className="fixed-top d-flex align-items-center">
                    <div className="container">
                        <div className="header-container d-flex align-items-center">
                            <div className="logo mr-auto">
                                <h1 className="text-light"><a href="#header"><span>Chemestic Engineer</span></a></h1>
                ...
                <section id="sci" className="en-chem">
                    <div className="container">
                        <div className="text-center" data-aos="zoom-in">
                            <h3 className="mt-5">Department of Chemestic Engineer</h3>
                    ...
                    <div className="testimonials section-bg ">
                        ...
                        <div className="testimonial-item1 container mt-5">
                                ...
                                <br />
                                <br />
                            <h3 >สาขาวิศวกรรมเคมี </h3>
                            <h4>Department of Chemestic Engineer</h4>
                            <h4>จำนวนผู้เข้าชม : {this.state.chemencount}</h4>
