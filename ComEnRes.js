...
class ComEnRes extends Component {
    ...
    componentDidMount() {
        const stringCount = localStorage.getItem("comencount" );
        const comencount  = parseInt(stringCount, 10);
  
        if (!isNaN(comencount) ) {
          this.setState(() => ({ comencount }));
        }
      }
    
      componentDidUpdate(prevProps, prevState) {
        if (prevState.comencount !== this.state.comencount) {
          localStorage.setItem("comencount", this.state.comencount);
        }
        ...
        if (prevState.userpoint !== this.state.userpoint){
            ...
            this.setState({
                series: [
                    {
                        name: "Highest Point",
                        data: [21540,	20455	,21893	,19571,	19862,	20550,	21303]
                    },
                    {
                        name: "Lowest Point ",
                        data: [18409,	17904,	18472	,17559	,17804	,19796	,19965]
                    },
                    {
                        name: "My Point",
    ...
    handleAddOne() {
        this.setState(prevState => {
          return {
            comencount: prevState.comencount +1
          };
        }
        );
      }
    render() {
        return (<React.Fragment>
            ...
            <header id="header" className="fixed-top d-flex align-items-center">
                    <div className="container">
                        <div className="header-container d-flex align-items-center">
                            <div className="logo mr-auto">
                                <h1 className="text-light"><a href="#header"><span>Computer Engineer</span></a></h1>
                ...
                <section id="sci" className="en-com">
                    <div className="container">
                        <div className="text-center" data-aos="zoom-in">
                            <h3 className="mt-5">Department of Computer Engineer</h3>
                    ...
                    <div className="testimonials section-bg ">
                        ...
                        <div className="testimonial-item1 container mt-5">
                            ...
                            <h4>Department of Computer Engineer</h4>
                            <h4>จำนวนผู้เข้าชม : {this.state.comencount}</h4>
